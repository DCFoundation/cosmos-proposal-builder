    ...
    >
      <div className="text-center">
        <svg className={`mx-auto`} xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
          <path d="M24.0833 24.0833L31.1666 17L24.0833 9.91667M9.91665 9.91667L2.83331 17L9.91665 24.0833M19.8333 4.25L14.1666 29.75" stroke="#D3482C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
